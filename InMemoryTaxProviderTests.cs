...
namespace TaxingTests
{
    ...
    public class InMemoryProviderTests
    {
        ...
        {
            var tax1 = new MunicipalityTaxDetails() { MunicipalitySchedule = new MunicipalityTaxSchedule("Vilnius", ScheduleFrequency.Daily, new DateTime(2016, 06, 05)), TaxAmount = 0.5 };
            var tax2 = new MunicipalityTaxDetails() { MunicipalitySchedule = new MunicipalityTaxSchedule("Vilnius", ScheduleFrequency.Weekly, new DateTime(2016, 06, 05)), TaxAmount = 1.0 };
            var tax3 = new MunicipalityTaxDetails() { MunicipalitySchedule = new MunicipalityTaxSchedule("Kaunas", ScheduleFrequency.Daily, new DateTime(2016, 06, 05)), TaxAmount = 1.5 };
            var tax4 = new MunicipalityTaxDetails() { MunicipalitySchedule = new MunicipalityTaxSchedule("Vilnius", ScheduleFrequency.Daily, new DateTime(2016, 06, 18)), TaxAmount = 2.0 };
